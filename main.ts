...
// Greetings
let names2: string[] = ["John", "Jane", "Alice"];
let greetingMessage: string = "Hello, would you like to join us for dinner?";
for (let name of names) {
...
// Changing Guest List
let dinnerGuests2: string[] = ["Albert Einstein", "Leonardo da Vinci", "Marie Curie"];
...
while (dinnerGuests.length > 2) {
    let removedGuest: string | undefined = dinnerGuests.pop(); // Assigning type string | undefined
...
// Think of Something
let mountains: string[] = ["Everest", "K2", "Matterhorn", "Kangchenjunga"];
...
let fruits1: string[] = ["banana", "strawberry", "mango"];
...
// Checking Usernames
let current_users: string[] = ["John", "Eric", "Jane", "Diana", "Lisa"];
let new_users: string[] = ["Peter", "Eric", "Jane", "Steven", "Diana"];
...
// Magicians
let magicians: string[] = ["David Copperfield", "David Blaine", "Penn & Teller"];
...
// Cars
function car_info(manufacturer: string, model_name: string, ...options: string[]) {
    let car: { manufacturer: string, model_name: string, [key: string]: string } = {
